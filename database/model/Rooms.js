...
const Rooms = new Schema({
    ...
    photoURL: {
        type: String,
        default: 'https://www.vietravel.com/Images/no-image-available.jpg',
    },
    members: {
        type: Array,
        minLength: 1,
    ...
    background: {
        type: String,
        default: 'https://firebasestorage.googleapis.com/v0/b/messenger-359a9.appspot.com/o/kamiHouse.png?alt=media&token=589effa1-7c63-45e0-922d-bb067034d75c',
    },
    lastested: {
        type: Date,
        default: Date.now(),
